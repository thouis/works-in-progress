...
cursor.execute('
SELECT PLATE_ID,PLATE_NAME,WELL_ROW_LABEL, WELL_COL_LABEL, CHEMICAL_NAME FROM WELL NATURAL JOIN CHEMICAL_WELL NATURAL JOIN CHEMICAL NATURAL JOIN PLATE WHERE PLATE_ID IN (0445)')
